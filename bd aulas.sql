...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Set-2023 às 19:29
...
INSERT INTO `cidades` (`id`, `id_estado`, `municipio`) VALUES
...
CREATE TABLE `usuarios` (
  ...
  `redesocial` varchar(100) NOT NULL,
...
INSERT INTO `usuarios` (`id`, `nome`, `nascimento`, `sexo`, `telefone`, `redesocial`, `id_cidade`, `login`, `senha`, `foto`) VALUES
(29, 'Alice Becker', '0000-00-00', '', '', '', 4316006, '', '', ''),
(30, 'Álison De Rozado Batista', '0000-00-00', '', '', '', 4316006, '', '', ''),
(31, 'Bruno Felipe Lampert Sander', '0000-00-00', '', '', '', 4316006, '', '', ''),
(32, 'Carlos Eduardo Renz Benchimol', '0000-00-00', '', '', '', 4316006, '', '', ''),
(33, 'Élvis Kasick Crippa', '0000-00-00', '', '', '', 4316006, '', '', ''),
(34, 'Emanuelly Fonseca Perfeito', '0000-00-00', '', '', '', 4316006, '', '', ''),
(35, 'Fernanda Dias De Oliveira', '0000-00-00', '', '', '', 4316006, '', '', ''),
(36, 'João Vitor Pereira Dos Santos', '0000-00-00', '', '', '', 4316006, '', '', ''),
(37, 'Júlia Hadassa Zucco', '0000-00-00', '', '', '', 4316006, '', '', ''),
(38, 'Kauã Davi Wüst', '0000-00-00', '', '', '', 4316006, '', '', ''),
(39, 'Larissa Vitória Kich', '0000-00-00', '', '', '', 4316006, '', '', ''),
(40, 'Lavínia Mariano Da Rosa', '0000-00-00', '', '', '', 4316006, '', '', ''),
(41, 'Luciéle Cristini Corrêa', '0000-00-00', '', '', '', 4316006, '', '', ''),
(42, 'Manuela Fernanda Leichtveis', '0000-00-00', '', '', '', 4316006, '', '', ''),
(43, 'Matheus Lauck Hennemann', '0000-00-00', '', '', '', 4316006, '', '', ''),
(44, 'Pablo Luís Da Silva', '0000-00-00', '', '', '', 4316006, '', '', ''),
(45, 'Thauany De Castro Dos Santos', '0000-00-00', '', '', '', 4316006, '', '', ''),
(46, 'Thiago Winicius Da Silva', '0000-00-00', '', '', '', 4316006, '', '', ''),
(47, 'Treyci Gabrielle Da Rosa', '0000-00-00', '', '', '', 4316006, '', '', ''),
(48, 'Vitor Matheus Engeroff', '0000-00-00', '', '', '', 4316006, '', '', ''),
(49, 'Yuri Henrique Lima Schoenardie', '0000-00-00', '', '', '', 4316006, '', '', ''),
(50, 'Yuri Samuel Torma Roos', '0000-00-00', '', '', '', 4316006, '', '', ''),
(51, 'Administrador', '2000-01-01', '', '', '', 4316006, 'admin', '1234', '');
...
ALTER TABLE `cidades`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cities_state_id_foreign` (`id_estado`);
...
--
ALTER TABLE `cidades`
  ADD CONSTRAINT `cities_state_id_foreign` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id`);
COMMIT;
